...
my_pizzas = ['pepperoni','mixed','mushroom and meat']
for my_pizza in my_pizzas:
    print(my_pizza)
    print(f'i like {my_pizza} pizza.')
...
animals = ['dog','cat','parrot','fish','rabbit']
...
menu = ('salad','pasta','chicken','beef','pizza')
print('original menu:')
for value in menu:
    print(value)
new_menu = ('pasta','chicken','pizza')
print('modified menu:')
for value in new_menu:
    print(value)