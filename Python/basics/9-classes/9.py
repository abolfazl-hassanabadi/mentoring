...
user1 = User('younes','gharaie',21)
user2 = User('abolfazl','hassanabadi',19)
...
user = User('abolfazl','hassanabadi',19)
...
ice_cream_stand = Ice_Cream_Stand('cool treats')
